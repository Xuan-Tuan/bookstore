...
// (No public routes for user management)
 ...
 *         description: Internal server error
 */
router.get("/", middlewareGroups.adminOnly, UserController.getAllUsers);
 ...
 *         description: Internal server error
 */
router.post("/", middlewareGroups.adminOnly, UserController.createUser);
 ...
 *         description: Internal server error
 */
router.get("/stats", middlewareGroups.adminOnly, UserController.getUserStats);
 ...
 *         description: Internal server error
 */
router.get("/search", middlewareGroups.adminOnly, UserController.searchUsers);
 ...
 *         description: Internal server error
 */
router.get("/:userID", middlewareGroups.protected, UserController.getUserById);
